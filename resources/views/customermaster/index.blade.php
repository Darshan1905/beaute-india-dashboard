...
<div class="container-fluid">
      ...
      <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Comstomer Master</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ URL::to('/') }}">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Comstomer Master</li>
            </ol>
        </div>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        ...
                        <h6 class="card-title mb-1">Cusotmer Master</h6>
                        ...
                        @can('role-create')
                            <span class="float-right">
                                <a class="btn btn-primary" href="{{ route('customermaster.create') }}">Create Customer Master</a>
                            </span>
                        @endcan
                    </div>
    ...
    $(document).ready(function () {
        ...
        table = $('#exportexample1').DataTable({
            ...
            columns: [
                ...
                {data: 'communication_address', name: 'communication_address'},
