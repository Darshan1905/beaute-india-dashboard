...
<div class="container-fluid">
      ...
      <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Industry Segment</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ URL::to('/') }}">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Industry Segment</li>
            </ol>
        </div>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        ...
                        <h6 class="card-title mb-1">Industry Segment</h6>
                        ...
                        @can('role-create')
                            <span class="float-right">
                                <a class="btn btn-primary" href="{{ route('industrysegments.create') }}">New Industry Segment</a>
                            </span>
                        @endcan
                    </div>
 ...
 <script>
    ...
    $(document).ready(function () {
        ...
        table = $('#exportexample1').DataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "{{ route('industrysegments-list') }}",
                "type": "get",
            },
            columns: [
                {data: 'id', name: 'id'},
