                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div>
                            ...
                            @can('role-create')
                                <span class="float-left">
                                    <a class="btn btn-success" data-target="#modaldemo1" data-toggle="modal"
                                        href="javascript: void(0);">Import Bulk Products</a>
                                </span>
                        ...
                        <div class="table-responsive">
                            <form method="post" action="{{ url('products-deletes') }}">
                                {{ csrf_field() }}
                                <br>
                                <input class="btn btn-success" type="submit" name="submit" value="Delete All Product" />
                                <br><br>
                                <table id="exportexample1"
            ...
            <div class="modal-content modal-content-demo">
                <form enctype="multipart/form-data" action="{{ route('import') }}" id="importfile" method="POST">
                    ...
                    <div class="modal-header">
                        <h6 class="modal-title">Product Excel Import</h6><button aria-label="Close" class="close"
