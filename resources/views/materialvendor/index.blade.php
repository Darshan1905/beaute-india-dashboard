...
<div class="container-fluid">
      ...
      <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Material Vendor</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ URL::to('/') }}">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Material Vendor</li>
            </ol>
        </div>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        ...
                        <h6 class="card-title mb-1">Material Vendor</h6>
                        ...
                        @can('role-create')
                            <span class="float-right">
                                <a class="btn btn-primary" href="{{ route('materialvendor.create') }}">Create Material Vendor</a>
                            </span>
                        @endcan
                    </div>
