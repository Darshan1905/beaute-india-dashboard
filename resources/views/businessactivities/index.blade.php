...
<div class="container-fluid">
      ...
      <div class="page-header">
        <div>
            <h2 class="main-content-title tx-24 mg-b-5">Business Activity</h2>
            <ol class="breadcrumb">
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        ...
                        <h6 class="card-title mb-1">Business Activity</h6>
                        ...
                        @can('role-create')
                            <span class="float-right">
                                <a class="btn btn-primary" href="{{ route('businessactivities.create') }}">Business Activity</a>
                            </span>
                        @endcan
                    </div>
 ...
 <script>
    ...
    $(document).ready(function () {
        ...
        table = $('#exportexample1').DataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "{{ route('businessactivities-list') }}",
                "type": "get",
            },
            columns: [
                {data: 'id', name: 'id'},
